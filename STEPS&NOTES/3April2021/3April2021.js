...
//7.also create new file inside controller and name it as user.js and then code inside user.js
//8.now create routes inside library folder
//9.also create new file inside routes and name it as user.js and then code inside user.js
